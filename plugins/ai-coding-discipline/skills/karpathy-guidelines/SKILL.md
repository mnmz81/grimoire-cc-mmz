...
Karpathy's observations on LLM coding pitfalls. Merge with project-specific
...
rewrites due to overcomplication, and clarifying questions come before implementation
